...
def game():
   ...
   #function will display the no of entry box that is been guessed
    ...
    def p_disp():       #run once at begning randomly select one and display spaces
        ...
        text2 = (f1.readline())
        #print text2
        text_box=Label(root,text="Hint : "+text2,font="Georgia",bg="cyan")
    ...
    bb1=Button(bottomframe,text="Play Again",bg="blue",fg="yellow",command=play_again)
    bb2=Button(bottomframe,text=" EXIT ",bg="red",fg="yellow",command=quit)
    pp.pack(side=TOP)
    a.pack(side=LEFT)
    b.pack(side=LEFT)
    c.pack(side=LEFT)
